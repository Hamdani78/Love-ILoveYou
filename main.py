...
# Mengambil resolusi device/browser
...
async def main():
    # PENTING: screen didaftarkan sebagai global agar tidak crash saat resize
    ...
    while running:
        ...
        # Skala bentuk hati menyesuaikan ukuran layar
        ...
        # Wajib untuk perulangan asynchronous browser
